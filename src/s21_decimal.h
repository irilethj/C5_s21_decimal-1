...
#define MINUS 0b10000000000000000000000000000000  // 2147483648
...
void s21_add_for_compare(s21_decimal value_1, s21_decimal value_2,
                         s21_decimal* result);
void s21_subtraction(s21_big_decimal value_1, s21_big_decimal value_2, s21_big_decimal* result);
int s21_get_bit_int(int x, int index);
void s21_set_scale(s21_big_decimal* dst, int scale);
void s21_print_int(int x);
int s21_compare_mantissa(s21_decimal value_1, s21_decimal value_2, int common_sign);
...
int s21_dis(s21_big_decimal* dividend, s21_big_decimal divider, s21_big_decimal* get);
...
void s21_banking_rounding(s21_big_decimal* value, int remaind, int prev_remaind);
void s21_mult(s21_big_decimal value_1, s21_big_decimal value_2, s21_big_decimal* result);
